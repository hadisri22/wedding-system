  ...
  <section id="service" class="services-mf route mt-4">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="venue.php">
          <div class="service-box" style="background-image:url(img/venues.jpg); background-size: cover;">
        ...
        <div class="col-md-4">
          <a href="theme.php">
           <div class="service-box" style="background-image:url(img/themes.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
        ...
        <div class="col-md-4">
             <a href="cat.php">
           <div class="service-box" style="background-image:url(img/cats.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
        ...
        <div class="col-md-4">
             <a href="music.php">
           <div class="service-box" style="background-image:url(img/music.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
        ...
        <div class="col-md-4">
           <a href="photo.php">
           <div class="service-box" style="background-image:url(img/photos.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
        ...
        <div class="col-md-4">
          ...
          <div class="service-box" style="background-image:url(img/decorations.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
